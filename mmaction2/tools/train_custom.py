...
def parse_args():
    ...
    config = "/home/daton/PycharmProjects/pythonProject/mmaction2/configs/detection/ava/" + \
             "slowfast_kinetics_pretrained_r50_4x16x1_20e_ava_rgb_custom_classes.py"
    parser.add_argument('--config', help='train config file path', default=config)
